...
const footerLinks = {
  Servicios: [
    { label: "Evaluación Financiera", href: "/servicios#evaluacion-financiera" },
    { label: "IA Generativa Aplicada", href: "/servicios#ia-generativa" },
    { label: "Estrategias de Financiación", href: "/servicios#financiacion" },
    { label: "PRIME-10 Assessment", href: "/prime-10" },
  ],
  Explorar: [
