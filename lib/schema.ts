...
export const professionalServiceSchema = {
  ...
  knowsAbout: [
    ...
    "asesoría en transferencia tecnológica para empresas",
...
export const personSchema = {
  ...
  description:
    "Evaluación financiera para proyectos I+D+i. PhD(c) en gestión de innovación tecnológica. Especialista en evaluación financiera bajo incertidumbre e IA generativa aplicada.",
  knowsAbout: [
    "Consultoría de Innovación",
    "Metodologías de Innovación",
